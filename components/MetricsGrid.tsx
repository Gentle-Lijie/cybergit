...
export const MetricsGrid: React.FC<MetricsGridProps> = ({ totalContributions, commits, prs, issues, reviews }) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="bg-surface-dark border border-primary/30 p-6 md:p-8 shadow-neon group flex flex-col justify-center relative overflow-hidden min-h-[200px] md:min-h-[240px]">
            <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity duration-700">
              <span className="material-symbols-outlined text-[80px] md:text-[120px] text-primary">hub</span>
            </div>
            
            <div className="relative z-10 flex flex-col h-full justify-between gap-4">
              <div>
                <p className="text-primary text-xs font-bold tracking-[0.3em] mb-2 uppercase flex items-center gap-2">
                  <span className="material-symbols-outlined text-sm animate-spin animate-reverse">sync</span>
                  Annual Output
                </p>
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-primary font-bold text-sm md:text-lg tracking-widest">CONTRIBUTIONS</span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 gap-4 h-full">
              ...
              <div key={idx} className="bg-surface-dark border border-primary/20 p-4 hover:bg-surface-light transition-colors group flex flex-col justify-center gap-2">
                  <div className="flex items-center justify-between">
                      ...
                      <span className="material-symbols-outlined text-primary text-lg md:text-xl">{item.icon}</span>
                      </div>
